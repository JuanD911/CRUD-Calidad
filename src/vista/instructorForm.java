...
public class instructorForm {
	...
	private void initialize() {
		...
		frmMonitor.setTitle("Instructor");
		...
		JLabel lblnombre = new JLabel("Ingrese el nombre del instructor");
		...
		JLabel lbltelefono = new JLabel("Ingrese el telefono del instructor");
		...
		JLabel lblDireccion = new JLabel("Ingrese la direccion del instructor");
		...
		JLabel lblcorreo = new JLabel("Ingrese el correo electronico del instructor");
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				instructorDAO.agregarInstructor(textField_nombre.getText(), textField_telefono.getText(), textField_direccion.getText(), textField_correo.getText(), textField_fecha.getText());
				cargarDatos();
			}
		});
		...
		btnEliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				instructorDAO.eliminarInstructor(Integer.parseInt(id_e));
				cargarDatos();
			}
		});
		...
		btnActualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Instructor i = instructorDAO.ponerInstructorEnTextFields(Integer.parseInt(id_a));
				
				textField_nombre.setText(i.getNombre());
				textField_telefono.setText(i.getTelefono());
				textField_direccion.setText(i.getDireccion());
				textField_correo.setText(i.getC_electronico());
				textField_fecha.setText(i.getF_nacimiento());
		...
		btnActualizar_deverdad.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				instructorDAO.actualizarInstructor(Integer.parseInt(id_a), textField_nombre.getText(), textField_telefono.getText(), textField_direccion.getText(), textField_correo.getText(), textField_fecha.getText());
				cargarDatos();
			}
		});
